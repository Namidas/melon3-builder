...
I know there already are existing tools for each of those tasks, but I felt more like doing a fun little experiment and...hell, why not? Let's just reinvent the wheel and put those 2 "things" into a single tool.
